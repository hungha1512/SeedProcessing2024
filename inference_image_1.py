...
IMAGE_PATH = '/Users/thanhhuongtran/Documents/him/seed-size/seed_ground_truth/raw_images/Anh1.jpg'
PRETRAINED_WEIGHT = 'unet_model.h5'
...
def calculate_coin_diameter(mask, min_size=30, OBJECT_THRESHOLD=0.5):
    """
...
REAL_COIN_DIAMETER_MM = 20.0  # 20mm
def calculate_dimensions(mask, mask_threshold=0.5, min_coin_size=30):
  ...
  coin_dia = max([max(x) for x in dimensions])
  if coin_dia < 30:
    print(f'WARNING! COIN DIAMETER < 30 PIXELS, SEED PIXEL, MASK THRESHOLD MAY DECREASE FOR BETTER RESULTS')
    return dimensions
  dimensions_mm = []
